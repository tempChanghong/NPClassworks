...
var names=['npclassworks-logo','npclassworks-logo-small','npclassworks-logo-mono','npclassworks-logo-mono-light'];
...
var ref=app.open(new File('C:/Users/Changhong/Downloads/download.png'));
