...
variants = [
 {'key':'standard','file':'npclassworks-logo','paths':[
  ['Lower folded sheet',FOLD,LOWER],['Front sheet',MAIN,FRONT],
  ['Upper turned page',MAIN,UPPER],['Warm orange ribbon',LEAF,RIGHT]]},
 {'key':'small','file':'npclassworks-logo-small','paths':[
  ['Simplified lower sheet',MAIN,SMALL_LOWER],['Upper turned page',MAIN,UPPER],
  ['Open inner ribbon',LEAF,SMALL_RIGHT]]},
 {'key':'mono','file':'npclassworks-logo-mono','paths':[
  ['Lower silhouette','#202E35',SMALL_LOWER],['Upper silhouette','#202E35',MONO_UPPER_RIGHT]]},
 {'key':'mono-light','file':'npclassworks-logo-mono-light','paths':[
...
for v in variants:
    parts=['<?xml version="1.0" encoding="UTF-8"?>',
           ...
           '<title id="title">NPClassworks — '+v['key']+'</title>',
